...
// ================================================================
// DETAIL PROJECT PUBLIC (DAPAT DILIHAT TANPA LOGIN)
// ================================================================

Route::get('/freelancer/projects/{project}', [ProjectBrowseController::class, 'show'])->name('freelancer.projects.show');


// ================================================================
// FREELANCER ROUTES (WAJIB LOGIN + ROLE FREELANCER)
// ================================================================
...
Route::middleware(['auth', 'ensureFreelancer'])
    ...
    ->group(function () {
        ...
        Route::get('/workspaces/{workspace}', [WorkspaceController::class, 'show'])->middleware('ensureWorkspacePaid')->name('workspaces.show');
        Route::post('/workspaces/{workspace}/message', [WorkspaceController::class, 'sendMessage'])->middleware('ensureWorkspacePaid')->name('workspaces.message');
        Route::post('/workspaces/{workspace}/progress', [WorkspaceController::class, 'updateProgress'])->middleware('ensureWorkspacePaid')->name('workspaces.progress');

        // Submissions
        Route::post('/workspaces/{workspace}/submissions', [ProjectSubmissionController::class, 'store'])->middleware('ensureWorkspacePaid')->name('workspaces.submissions.store');
...
// ================================================================
// COMPANY ROUTES (WAJIB LOGIN + ROLE COMPANY)
// ================================================================
...
Route::middleware(['auth', 'ensureCompanyAdminOrAbort'])
    ...
    ->group(function () {
        ...
        // Profile Freelancer (Read-only)
        Route::get('/freelancer-profile/{id}', [FreelancerProfilController::class, 'profile'])->name('freelancer.profile');

        // Submissions
        Route::post('/workspaces/{workspace}/submissions/{submission}/accept', [ProjectSubmissionController::class, 'accept'])->middleware('ensureWorkspacePaid')->name('workspaces.submissions.accept');
        Route::post('/workspaces/{workspace}/submissions/{submission}/revision', [ProjectSubmissionController::class, 'requestRevision'])->middleware('ensureWorkspacePaid')->name('workspaces.submissions.revision');
