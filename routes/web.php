...
Route::middleware(['auth', 'ensureCompanyAdminOrAbort'])
    ...
    ->group(function () {
        ...
        // Payment
        Route::get('/workspaces/{workspace}/payment/gateway', [
            CompanyPaymentController::class,
            'showGateway'
        ])->name('payments.gateway');

        Route::get('/workspaces/{workspace}/payment/upload', [
            CompanyPaymentController::class,
            'showUploadForm'
        ])->name('payments.upload-form');

        Route::post('/workspaces/{workspace}/payment/upload', [
            CompanyPaymentController::class,
            'uploadProof'
        ])->name('payments.upload');

        Route::post('/workspaces/{workspace}/payment/midtrans', [
            CompanyPaymentController::class,
            'createMidtransTransaction'
        ])->name('payments.midtrans');

        Route::post('/workspaces/{workspace}/payment/confirm', [
            CompanyPaymentController::class,
            'confirmPayment'
