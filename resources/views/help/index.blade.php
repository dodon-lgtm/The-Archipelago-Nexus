...
<body>
    ...
    <header class="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            <div class="h-20 flex items-center justify-between">
                ...
                >
                    <div
                        class="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/20 group-hover:scale-105 transition-transform duration-300"
                    >
                ...
                <a
                    href="{{ url('/') }}"
                    class="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 rounded-xl border border-blue-100 bg-white text-slate-700 font-bold text-sm hover:bg-blue-50 hover:text-blue-600 hover:border-blue-200 transition-all duration-300 shadow-sm"
                >
    ...
    ========================================================== --}}
    <section
        class="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-sky-50"
    >

        {{-- Decorative background --}}
        <div
            class="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-blue-200/30 blur-3xl"
        ></div>

        <div
            class="absolute -bottom-40 -left-32 w-96 h-96 rounded-full bg-indigo-200/20 blur-3xl"
        ></div>


        <div
            class="relative max-w-5xl mx-auto px-5 sm:px-6 py-20 sm:py-24 text-center"
        >

            {{-- Badge --}}
            <div
                class="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-blue-100 bg-blue-50 text-blue-600 text-sm font-bold mb-7"
            >
            ...
            {{-- Heading --}}
            <h2
                class="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-slate-950 leading-tight"
            >
            ...
            {{-- Description --}}
            <p
                class="mt-5 max-w-3xl mx-auto text-base sm:text-lg leading-8 text-slate-500"
            >
    ...
    <section class="bg-white border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <a
                    href="#akun"
                    class="group rounded-2xl border border-slate-200 bg-white p-6 hover:border-blue-200 hover:shadow-lg hover:shadow-blue-100/40 transition-all duration-300"
                >
                    <div
                        class="w-12 h-12 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center mb-5 group-hover:scale-105 transition-transform"
                    >
                ...
                <a
                    href="#proyek"
                    class="group rounded-2xl border border-slate-200 bg-white p-6 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-100/40 transition-all duration-300"
                >
                    <div
                        class="w-12 h-12 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center mb-5 group-hover:scale-105 transition-transform"
                    >
                ...
                <a
                    href="#pembayaran"
                    class="group rounded-2xl border border-slate-200 bg-white p-6 hover:border-sky-200 hover:shadow-lg hover:shadow-sky-100/40 transition-all duration-300"
                >
                    <div
                        class="w-12 h-12 rounded-xl bg-sky-50 text-sky-600 flex items-center justify-center mb-5 group-hover:scale-105 transition-transform"
                    >
                ...
                <a
                    href="#keamanan"
                    class="group rounded-2xl border border-slate-200 bg-white p-6 hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-100/40 transition-all duration-300"
                >
                    <div
                        class="w-12 h-12 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center mb-5 group-hover:scale-105 transition-transform"
                    >
    ...
    <main class="max-w-5xl mx-auto px-5 sm:px-6 py-16 sm:py-20">
        ...
        <section id="akun" class="mb-16 scroll-mt-28">
            ...
            <div class="space-y-4">
                ...
                {{-- FAQ 1 --}}
                <div class="faq-item rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-sm">

                    <button
                        type="button"
                        class="faq-button w-full flex items-center justify-between gap-5 text-left px-6 py-5 hover:bg-slate-50 transition-colors"
                    >
                        <span class="font-bold text-slate-900 leading-7">
                            Bagaimana cara membuat akun di ApexForge Labs?
                        </span>

                        <span
                            class="faq-icon shrink-0 w-9 h-9 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center"
                        >
                ...
                <div class="faq-item rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-sm">
                    ...
                    >
                        ...
                        <span class="faq-icon shrink-0 w-9 h-9 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center">
                            <i class="fa-solid fa-chevron-down text-sm"></i>
                        </span>
                    </button>
            ...
            <div class="space-y-4">
                ...
                <div class="faq-item rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-sm">
                    ...
                    >
                        ...
                        <span class="faq-icon shrink-0 w-9 h-9 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center">
                            <i class="fa-solid fa-chevron-down text-sm"></i>
                        </span>
                    </button>
        ...
        <section id="pembayaran" class="mb-16 scroll-mt-28">
            ...
            <div class="mb-7">
                <div class="flex items-center gap-3 mb-3">
                    <div
                        class="w-10 h-10 rounded-xl bg-sky-50 text-sky-600 flex items-center justify-center"
                    >
            ...
            <div class="space-y-4">
                ...
                <div class="faq-item rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-sm">
                    ...
                    >
                        ...
                        <span class="faq-icon shrink-0 w-9 h-9 rounded-xl bg-sky-50 text-sky-600 flex items-center justify-center">
                            <i class="fa-solid fa-chevron-down text-sm"></i>
                        </span>
                    </button>
            ...
            <div class="space-y-4">
                ...
                <div class="faq-item rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-sm">
                    ...
                    >
                        ...
                        <span class="faq-icon shrink-0 w-9 h-9 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center">
                            <i class="fa-solid fa-chevron-down text-sm"></i>
                        </span>
                    </button>
        ...
        <section class="mb-20">
            ...
            <div
                class="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-blue-600 via-blue-600 to-indigo-700 px-7 py-10 sm:px-12 sm:py-12 text-white shadow-xl shadow-blue-200/40"
            >
                ...
                <div class="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                    ...
                    <div class="shrink-0">
                        ...
                        <a
                            ...
                            class="w-full lg:w-auto inline-flex items-center justify-center gap-3 px-6 py-4 rounded-2xl bg-white text-blue-700 font-extrabold shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all duration-300"
                        >
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        class="inline-flex items-center gap-2 text-sm font-bold text-white hover:text-blue-400 transition-colors"
                    >
