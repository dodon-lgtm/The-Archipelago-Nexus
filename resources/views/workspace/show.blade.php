...
<body class="bg-white text-blue-950 min-h-screen flex antialiased relative font-sans">
    ...
    <div class="flex-1 min-w-0 flex flex-col min-h-screen relative z-10">
        ...
        <main class="flex-1 min-w-0 overflow-y-auto">
            <div class="max-w-7xl mx-auto px-6 py-10">
                ...
                <div class="flex items-center gap-3 text-xs font-bold text-blue-300 uppercase tracking-widest mb-8">
                    @if (auth()->user()->role === 'company')
                        <a href="{{ route('company.workspaces.index') }}"
                            class="hover:text-blue-600 transition">Workspace</a>
                    @else
                        <a href="{{ route('freelancer.workspaces.index') }}"
                            class="hover:text-blue-600 transition">Workspace Saya</a>
                    @endif
                ...
                @if (session('success'))
                    <div
                        class="mb-8 overflow-hidden relative bg-blue-50 border border-blue-200 p-4 rounded-2xl flex items-start gap-4">
                        <div
                            class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(59,130,246,0.4)]">
                ...
                @if (session('error'))
                    <div
                        class="mb-8 overflow-hidden relative bg-white border-2 border-blue-600 p-4 rounded-2xl shadow-[0_0_20px_rgba(59,130,246,0.15)] flex items-start gap-4">
                        <div
                            class="w-8 h-8 rounded-full bg-blue-100 text-blue-600 border border-blue-200 flex items-center justify-center shrink-0">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="md:col-span-1 glass-card rounded-3xl overflow-hidden">
                            <div
                                class="px-6 py-5 border-b border-blue-50/50 bg-gradient-to-b from-blue-50/50 to-transparent">
                                <h2 class="font-black text-sm text-blue-950 tracking-tight">
                                    {{ $workspace->project->project_name }}</h2>
                            </div>
                            <div class="p-6 space-y-5">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-[9px] font-black tracking-widest uppercase text-blue-400 mb-0.5">
                                            Perusahaan</p>
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-[9px] font-black tracking-widest uppercase text-blue-400 mb-0.5">
                                            Freelancer</p>
                                        <p class="text-xs font-bold text-blue-900">{{ $workspace->freelancer->name }}
                                        </p>
                                    </div>
                                </div>
                                @if ($workspace->project->deadline)
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p
                                                class="text-[9px] font-black tracking-widest uppercase text-blue-400 mb-0.5">
                                                Deadline</p>
                            ...
                            <div>
                                ...
                                <div class="p-6">
                                    <div class="text-center mb-5">
                                        ...
                                        @if ($totalStages > 0)
                                            <p
                                                class="text-[9px] font-bold uppercase tracking-widest text-blue-300 mt-1">
                                                Tahap {{ $activeStageOrder }} dari {{ $totalStages }}</p>
                                        @endif
                                    </div>
                                    <div
                                        class="w-full bg-blue-50 border border-blue-100 rounded-full h-3 overflow-hidden shadow-inner">
                                    ...
                                    @foreach ($stages as $index => $stage)
                                        ...
                                        <div
                                            ...
                                            <div class="min-w-0 flex-1 flex items-center justify-between">
                                                <p
                                                    class="text-xs font-bold truncate {{ $isActive ? 'text-white' : 'text-blue-900' }}">
                                                    {{ $stage }}
                                                </p>
                                                @if ($label)
                                                    <span
                    ...
                    <div class="glass-card rounded-3xl overflow-hidden flex flex-col h-[500px]">
                        {{-- Chat Header --}}
                        <div
                            class="px-6 py-4 border-b border-blue-50/50 bg-gradient-to-b from-blue-50/80 to-transparent flex items-center justify-between shrink-0">
                            <div class="flex items-center gap-4">
                                <div
                                ...
                                <div>
                                    ...
                                    <p class="text-[10px] font-bold text-blue-400 uppercase tracking-widest mt-0.5">
                                        {{ $workspace->project->project_name }}</p>
                                </div>
                            </div>
                            ...
                            @php
                                ...
                                $chatStatusMap = [
                                    ...
                                    'Menunggu Revisi' => [
                                        ...
                                        'box' => 'bg-white border-blue-200 text-blue-700',
                                    ],
                                    'Menunggu Pembayaran' => [
                                        'label' => 'Menunggu Pembayaran',
                                        'dot' => 'bg-blue-700 shadow-[0_0_8px_rgba(29,78,216,0.8)]',
                                        'box' => 'bg-blue-50 border-blue-200 text-blue-800',
                                    ],
                                    'Menunggu Verifikasi Admin' => [
                                        'label' => 'Menunggu Verifikasi Admin',
                                        'dot' => 'bg-blue-300 shadow-[0_0_8px_rgba(147,197,253,0.8)]',
                                        'box' => 'bg-white border-blue-100 text-blue-500',
                                    ],
                                    'Selesai' => [
                                        'label' => 'Selesai',
                                        'dot' => 'bg-white',
                                        'box' => 'bg-blue-600 border-blue-600 text-white shadow-md',
                                    ],
                                ];
                                $statusStyle = $chatStatusMap[$workspace->status] ?? [
                                    'label' => $workspace->status,
                                    'dot' => 'bg-blue-300',
                                    'box' => 'bg-white text-blue-400 border-blue-100',
                                ];
                            @endphp
                        ...
                        {{-- Chat Body --}}
                        <div id="chatBody"
                            class="flex-1 overflow-y-auto chat-scroll p-6 space-y-5 bg-white/40 hologram-grid-blue relative">
                                ...
                                @foreach ($workspace->messages as $message)
                                    @if ($message->type === 'system')
                                        <div class="flex justify-center my-6 relative z-10">
                                            <div
                                                class="bg-blue-50/80 backdrop-blur-sm text-blue-600 text-[10px] font-bold tracking-wide px-5 py-2 rounded-full border border-blue-100/50 inline-flex items-center gap-2 shadow-sm uppercase">
                                    ...
                                    @else
                                        ...
                                        <div
                                            class="flex {{ $isMine ? 'justify-end' : 'justify-start' }} relative z-10">
                                            <div
                                                class="max-w-[75%] {{ $isMine ? 'bg-gradient-to-br from-blue-600 to-blue-500 text-white rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl rounded-br-sm shadow-[0_5px_15px_rgba(37,99,235,0.2)]' : 'bg-white text-blue-900 border border-blue-100 rounded-tl-2xl rounded-tr-2xl rounded-br-2xl rounded-bl-sm shadow-sm' }} px-5 py-3.5">
                                                @if (!$isMine)
                                                    <p
                                                        class="text-[9px] font-black uppercase tracking-widest text-blue-400 mb-1.5">
                                                        {{ $message->sender->name }}
                                                    </p>
                                                @endif
                                                <p class="text-[13px] leading-relaxed font-medium">
                                                    {{ $message->message }}</p>
                                                <p
                                                    class="text-[9px] font-bold mt-2 {{ $isMine ? 'text-blue-200' : 'text-blue-300' }} text-right tracking-wider">
                            ...
                            @else
                                <div class="absolute inset-0 flex flex-col items-center justify-center">
                                    <div
                                        class="w-16 h-16 mx-auto mb-4 bg-blue-50 rounded-2xl border border-blue-100 flex items-center justify-center shadow-inner">
                                    ...
                                    <p class="text-xs font-semibold text-blue-400 mt-1">Mulai percakapan dengan
                                        mengirim pesan.</p>
                                </div>
                            @endif
                        </div>
                    ...
                    @if (auth()->user()->role === 'company' &&
                            in_array($workspace->status, ['Menunggu Pembayaran', 'Menunggu Verifikasi Admin']) &&
                            $payment)
                        <div class="glass-card rounded-3xl overflow-hidden">
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="bg-white border border-blue-100 rounded-2xl p-5 shadow-sm space-y-3">
                                        <div class="flex items-center justify-between border-b border-blue-50 pb-2">
                                            <p class="text-[10px] font-black text-blue-400 uppercase tracking-widest">
                                                Nomor Invoice</p>
                                            <span
                                                class="text-xs font-bold text-blue-950 bg-blue-50 px-2 py-0.5 rounded">{{ $payment->invoice_number }}</span>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <p class="text-[10px] font-black text-blue-400 uppercase tracking-widest">
                                                Total</p>
                                            <span class="text-sm font-bold text-blue-900">Rp
                                                {{ number_format($payment->amount, 0, ',', '.') }}</span>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <p class="text-[10px] font-black text-blue-400 uppercase tracking-widest">
                                                Biaya Platform (5%)</p>
                                            <span class="text-xs font-bold text-blue-500">Rp
                                                {{ number_format($payment->platform_fee, 0, ',', '.') }}</span>
                                        </div>
                                        <div
                                            class="flex items-center justify-between pt-3 border-t border-blue-100/50">
                                            <p class="text-[10px] font-black text-blue-600 uppercase tracking-widest">
                                                Total Dibayar</p>
                                            <span class="text-base font-black text-blue-700">Rp
                                                {{ number_format($payment->amount, 0, ',', '.') }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-white border border-blue-100 rounded-2xl p-5 shadow-sm space-y-3">
                                        ...
                                        @if ($payment->status === 'rejected')
                                            <div
                                                class="mt-4 p-3 bg-white border border-blue-400 rounded-xl relative overflow-hidden">
                                                <div class="absolute top-0 left-0 w-1 h-full bg-blue-500"></div>
                                                <p class="text-xs font-bold text-blue-900 ml-2">Pembayaran ditolak.
                                                    Silakan upload ulang.</p>
                                                @if ($payment->admin_note)
                                                    <p
                                                        class="text-[10px] text-blue-600 mt-2 ml-2 p-2 bg-blue-50 rounded-lg border border-blue-100">
                                                        Alasan: {{ $payment->admin_note }}</p>
                                                @endif
                                            </div>
                                        @endif
                                    </div>
                                ...
                                @if ($payment->status === 'pending')
                                    <div
                                        class="flex flex-col gap-4 bg-gradient-to-r from-blue-50 to-transparent p-5 rounded-2xl border border-blue-100">
                                        <p class="text-xs font-semibold text-blue-800 leading-relaxed max-w-2xl">
                                            Silakan lanjutkan ke <strong>Payment Gateway</strong> untuk melakukan
                                            pembayaran, kemudian upload bukti pembayaran pada halaman berikutnya.
                                        </p>
                                ...
                                @if ($payment->status === 'rejected')
                                    <form method="POST" action="{{ route('company.payments.upload', $workspace) }}"
                                        enctype="multipart/form-data"
                                        class="space-y-5 bg-white border border-blue-100 p-5 rounded-2xl shadow-sm">
                                        @csrf
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                            <div>
                                                <label
                                                    class="block text-[10px] font-black text-blue-500 uppercase tracking-widest mb-2">Metode
                                                    Pembayaran</label>
                                                <select name="payment_method" required
                                                    class="w-full px-4 py-3 bg-blue-50/50 border border-blue-100 rounded-xl text-sm font-bold text-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all">
                                            ...
                                            <div>
                                                <label
                                                    class="block text-[10px] font-black text-blue-500 uppercase tracking-widest mb-2">Upload
                                                ...
                                                <p
                                                    class="text-[9px] font-bold text-blue-400 mt-1.5 uppercase tracking-wide">
                                                    Format: jpg, jpeg, png, pdf. Maksimal 10 MB.</p>
                                            </div>
                                        </div>
                                        <div>
                                            <label
                                                class="block text-[10px] font-black text-blue-500 uppercase tracking-widest mb-2">Catatan
                                                (opsional)</label>
                                ...
                                @if ($payment->status === 'waiting_verification')
                                    <div
                                        class="flex items-center gap-3 px-5 py-4 bg-white border border-blue-200 rounded-2xl shadow-[0_5px_20px_rgba(59,130,246,0.1)]">
                                        <div
                                            class="w-10 h-10 rounded-full bg-blue-50 text-blue-500 flex items-center justify-center shrink-0 border border-blue-100">
                                            <i class="fa-solid fa-clock animate-pulse"></i>
                                        </div>
                                        <div>
                                            <p class="text-sm font-bold text-blue-900">Bukti pembayaran telah dikirim.
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="p-6">
                                    ...
                                    <div class="space-y-6">
                                        @foreach ($workspace->progressHistories as $history)
                                            <div class="relative pl-8 border-l border-blue-100/70 ml-2">
                                                <div
                                                    class="absolute -left-[13px] top-0 w-6 h-6 rounded-full bg-white border border-blue-200 shadow-[0_0_10px_rgba(59,130,246,0.2)] flex items-center justify-center z-10">
                                                    <span
                                                        class="text-[8px] text-blue-600 font-black">{{ $history->progress }}%</span>
                                                </div>
                                                <div
                                                    class="bg-blue-50/40 rounded-2xl p-4 border border-blue-50 ml-1 hover:bg-blue-50 hover:border-blue-100 transition-colors">
                                                    <div
                                                        class="flex flex-wrap items-center justify-between gap-2 mb-2 border-b border-blue-100/50 pb-2">
                                                        <span
                                                            class="text-xs font-black text-blue-900">{{ $history->stage }}</span>
                                                        <span
                                                            class="text-[9px] font-bold tracking-widest uppercase text-blue-400 bg-white px-2 py-0.5 rounded shadow-sm border border-blue-50">{{ $history->created_at->format('d M Y') }}</span>
                                                    </div>
                                                    @if ($history->description)
                                                        <p
                                                            class="text-[11px] font-medium text-blue-800/70 leading-relaxed">
                                ...
                                @else
                                    <div class="py-12 flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-xs font-bold text-blue-300 uppercase tracking-widest">Belum ada
                                            riwayat progress.</p>
                                    </div>
                                @endif
                            </div>
                        ...
                        {{-- Card: Actions & Rating --}}
                        <div
                            class="md:col-span-1 glass-card rounded-3xl overflow-hidden flex flex-col justify-between">
                            <div>
                                <div
                                    class="px-6 py-5 border-b border-blue-50/50 bg-gradient-to-b from-blue-50/50 to-transparent">
                                ...
                                <div class="p-6 space-y-4">
                                    @if (auth()->user()->role === 'company' && $workspace->status === 'Menunggu Review')
                                        <div
                                            class="flex items-center gap-3 px-4 py-3.5 bg-amber-50 border border-amber-200 rounded-xl text-amber-700">
                                    ...
                                    @if ($workspace->status === 'Selesai')
                                        <div class="pt-2">
                                            @if ($workspace->rating)
                                                <div
                                                    class="bg-blue-50 border border-blue-100 rounded-2xl p-5 text-center shadow-inner">
                                                    <p
                                                        class="text-[10px] font-black text-blue-400 uppercase tracking-widest mb-3">
                                                        Rating Telah Diberikan</p>
                                                    <div
                                                        class="flex justify-center gap-1.5 text-blue-500 text-lg mb-3 drop-shadow-[0_0_8px_rgba(59,130,246,0.4)]">
                                                        @for ($i = 1; $i <= 5; $i++)
                                                            <i
                                                    ...
                                                    @if ($workspace->rating->review)
                                                        <div class="relative">
                                                            <i
                                                                class="fa-solid fa-quote-left absolute -top-1 -left-1 text-blue-200 text-xl opacity-50"></i>
                                                            <p
                                                                class="text-xs font-semibold text-blue-900 italic px-4 leading-relaxed relative z-10">
                                                                "{{ $workspace->rating->review }}"</p>
                                                        </div>
                                                    @endif
                                                </div>
                                            @else
                                                ...
                                                @else
                                                    <div
                                                        class="text-center py-5 bg-white rounded-2xl border border-blue-50 border-dashed">
                                                        <p
                                                            class="text-[10px] font-bold text-blue-300 uppercase tracking-widest">
                                                            Belum ada rating dari perusahaan.</p>
                                                    </div>
                                                @endif
                                            @endif
                                        </div>
    ...
    <div id="progressModal"
        class="hidden modal-backdrop fixed inset-0 z-50 flex items-center justify-center bg-blue-950/40 backdrop-blur-md p-4">
        <div
            class="modal-panel bg-white rounded-3xl shadow-[0_20px_50px_rgba(30,58,138,0.2)] w-full max-w-md border border-blue-100 max-h-[90vh] flex flex-col overflow-hidden">

            {{-- Header (fixed, tidak ikut scroll) --}}
            <div
                class="relative px-6 py-7 bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 overflow-hidden shrink-0">
            ...
            <div class="overflow-y-auto flex-1 min-h-0">
                {{-- UI Guard: Tampilkan pesan terkunci jika dalam tahap pembayaran atau selesai --}}
                @if (in_array($workspace->status, ['Menunggu Pembayaran', 'Menunggu Verifikasi Admin', 'Selesai']))
                    <div class="p-6 bg-white space-y-4 text-center">
                        <div
                            class="p-4 bg-amber-50 border border-amber-200 text-amber-800 rounded-xl text-xs font-semibold">
                            <i class="fa-solid fa-triangle-exclamation text-amber-600 mr-1"></i>
                            Update progres saat ini dikunci karena pekerjaan berada pada tahap pembayaran, verifikasi
                            admin, atau sudah selesai.
                        </div>
                        <button type="button"
                ...
                @else
                    <form method="POST" action="{{ route('freelancer.workspaces.progress', $workspace) }}"
                        ...
                        <div>
                            <label
                                class="block text-[10px] font-black text-blue-500 uppercase tracking-widest mb-2">Tahap
                                Pengerjaan</label>
                            <select name="stage" id="stageSelect" required onchange="updateStageProgress()"
                                ...
                                @foreach ($stages as $stage)
                                    <option value="{{ $stage }}"
                                        {{ $activeStage === $stage ? 'selected' : '' }}>{{ $stage }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div>
                            <label
                                class="block text-[10px] font-black text-blue-500 uppercase tracking-widest mb-2">Progress
                                Saat Ini</label>
                            <div class="flex items-center gap-4 p-4 bg-blue-50 border border-blue-100 rounded-xl">
                                <span id="progressPreview"
                                    class="text-2xl font-black text-blue-600">{{ $progressValue }}%</span>
                                <div class="flex-1">
                                    <div
                                        class="w-full bg-white border border-blue-100 rounded-full h-2.5 overflow-hidden shadow-inner">
                                        <div id="progressPreviewBar"
                                            class="h-full rounded-full bg-blue-500 transition-all shadow-[0_0_8px_rgba(59,130,246,0.6)]"
                                            style="width: {{ $progressValue }}%"></div>
                                    </div>
                                </div>
                            </div>
                            <p class="text-[9px] font-bold text-blue-400 mt-2 flex items-start gap-1">
                                <i class="fa-solid fa-circle-info mt-0.5"></i> Persentase ditentukan otomatis dari
                                urutan tahap (tidak dapat diedit manual).
                            </p>
                        </div>

                        <div>
                            <label
                                class="block text-[10px] font-black text-blue-500 uppercase tracking-widest mb-2">Deskripsi</label>
                            ...
                            <p class="text-[9px] font-black text-blue-300 mt-1.5 text-right"><span
                                    id="progressDescCount">0</span>/500</p>
                        </div>
                    ...
                    <div class="px-6 py-5 bg-blue-50/30 border-t border-blue-100 space-y-4">
                        <p
                            class="text-[9px] font-black text-blue-400 uppercase tracking-widest flex items-center gap-1.5 mb-2">
                        ...
                        <form method="POST" action="{{ route('freelancer.workspaces.progress', $workspace) }}"
                            ...
                            <button type="submit"
                                class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-bold transition">Tambah</button>
                        </form>
                        ...
                        <form method="POST" action="{{ route('freelancer.workspaces.progress', $workspace) }}"
                            ...
                            <select name="old_stage"
                                class="w-1/3 px-2 py-2 bg-white border border-blue-100 rounded-lg text-xs font-semibold focus:outline-none focus:border-blue-400">
                                @foreach ($stages as $stage)
                                    <option value="{{ $stage }}"
                                        {{ $activeStage === $stage ? 'selected' : '' }}>{{ $stage }}</option>
                                @endforeach
                            ...
                            <button type="submit"
                                class="px-3 py-2 bg-blue-100 text-blue-600 border border-blue-200 hover:bg-blue-200 rounded-lg text-xs font-bold transition">Ganti</button>
                        </form>
                        ...
                        @if (!$isAtLastStage)
                            <form method="POST" action="{{ route('freelancer.workspaces.progress', $workspace) }}"
                                ...
                                <button type="submit"
                                    class="w-full px-4 py-2 bg-blue-100 border border-blue-200 text-blue-700 hover:bg-blue-200 rounded-lg text-xs font-bold transition flex items-center justify-center gap-2">
                                    Lanjut ke Tahap Berikutnya <i class="fa-solid fa-forward"></i>
                                </button>
                            </form>
                        @else
                            <div
                                class="w-full px-4 py-2.5 bg-blue-50 border border-blue-100 text-blue-400 rounded-lg text-[10px] font-bold tracking-wide text-center mt-2">
    ...
    @if (auth()->user()->role === 'company' && $workspace->status === 'Selesai')
        <div id="ratingModal"
            class="hidden modal-backdrop fixed inset-0 z-50 flex items-center justify-center bg-blue-950/40 backdrop-blur-md p-4">
            <div
                class="modal-panel bg-white rounded-3xl shadow-[0_20px_50px_rgba(30,58,138,0.2)] w-full max-w-md overflow-hidden border border-blue-100">
                <div
                    class="relative px-6 py-7 bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 overflow-hidden">
                    <div class="absolute inset-0 modal-header-pattern opacity-50"></div>
                    <div class="absolute -top-10 -right-10 w-32 h-32 bg-white/10 rounded-full blur-xl"></div>
                    <div class="absolute -bottom-12 -left-8 w-28 h-28 bg-white/10 rounded-full blur-xl"></div>
                    <div class="relative flex items-center justify-between">
                ...
                <form method="POST" action="{{ route('company.client.review.store', $workspace->project_id) }}"
                    ...
                    <div class="bg-blue-50 border border-blue-100 rounded-2xl p-5 text-center shadow-inner">
                        <label class="block text-[10px] font-black text-blue-500 uppercase tracking-widest mb-3">Pilih
                            Rating</label>
                        ...
                        <span
                            class="inline-block px-3 py-1 bg-white border border-blue-100 rounded text-[10px] font-black text-blue-600 uppercase tracking-widest shadow-sm"
                            id="ratingLabel">5 - Sempurna</span>
                    </div>

                    <div>
                        <label class="block text-[10px] font-black text-blue-500 uppercase tracking-widest mb-2">Ulasan
                            / Testimoni</label>
