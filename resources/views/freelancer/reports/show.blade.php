        ...
        <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
            <div class="max-w-5xl mx-auto space-y-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <a href="{{ route('freelancer.reports.index') }}" class="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-blue-600 font-semibold transition group w-fit">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        {{-- Report Card --}}
                        <div class="bg-white rounded-2xl border border-blue-100/80 shadow-sm overflow-hidden">
                            <div class="p-6">
                                <div class="flex items-start justify-between gap-4 mb-5 pb-5 border-b border-blue-50">
                                    <div class="space-y-1">
                                        <div class="flex items-center gap-2 flex-wrap">
                                            <span class="text-xs font-bold px-2.5 py-1 rounded-md bg-blue-50 text-slate-600 tracking-wide">
                                                #{{ $report->id }}
                                            </span>
                                            @if(class_exists('\App\Models\Report') && method_exists('\App\Models\Report', 'categoryLabel'))
                                                <span class="text-xs font-semibold px-2.5 py-1 rounded-md bg-blue-50 text-blue-700 border border-blue-100">
                                ...
                                <div class="space-y-2 mb-6">
                                    ...
                                    <div class="bg-[#f6f9ff] border border-blue-50 rounded-xl p-4 text-sm text-slate-700 leading-relaxed whitespace-pre-line">
                                        {{ $report->description }}
                                    </div>
                                </div>
...
{{-- Admin Note Block --}}
                                <div class="space-y-2">
                                    ...
                                    @if($report->admin_note)
                                        <div class="bg-blue-50/70 border border-blue-100 rounded-xl p-4 text-sm text-blue-900 leading-relaxed flex items-start gap-3">
                                            <i class="fa-solid fa-comment-dots text-blue-600 text-base mt-0.5 shrink-0"></i>
                                            <div>
                                                <p class="font-semibold text-xs text-blue-700 mb-1">Tanggapan dari Tim Modérasi:</p>
                                                <p class="whitespace-pre-line">{{ $report->admin_note }}</p>
                                            </div>
                                        </div>
                                    @else
                                        <div class="bg-[#f6f9ff] border border-dashed border-blue-100 rounded-xl p-4 text-sm text-slate-400 italic flex items-center gap-2">
...
{{-- Lampiran / Bukti --}}
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                            @foreach($report->attachments as $attachment)
                                                <div class="group rounded-xl border border-blue-100 overflow-hidden bg-[#f6f9ff] hover:border-blue-300 transition">
                    ...
                    <div class="space-y-6">
                        ...
                        {{-- Pelapor --}}
                        <div class="bg-white rounded-2xl border border-blue-100/80 shadow-sm p-5">
                        ...
                        @if($report->project)
                            <div class="bg-white rounded-2xl border border-blue-100/80 shadow-sm p-5">
                                ...
                                <div class="p-3 bg-[#f6f9ff] rounded-xl border border-blue-50 space-y-2 text-xs">
                                    <div>
                                    ...
                                    @if($report->project->owner)
                                        <div class="pt-2 border-t border-blue-100/60 flex justify-between items-center">
                        ...
                        @if($report->penawaran)
                            <div class="bg-white rounded-2xl border border-blue-100/80 shadow-sm p-5">
                                ...
                                <div class="p-3 bg-[#f6f9ff] rounded-xl border border-blue-50 space-y-2 text-xs">
                                    ...
                                    <div class="flex justify-between items-center pt-2 border-t border-blue-100/60">
                        ...
                        @if($report->handledBy || $report->resolved_at)
                            <div class="bg-white rounded-2xl border border-blue-100/80 shadow-sm p-5 space-y-3">
                                ...
                                <div class="space-y-2 text-xs">
                                    ...
                                    @if($report->resolved_at)
                                        <div class="flex justify-between items-center pt-2 border-t border-blue-50">
