...
<head>
    ...
    <style>
        ...
        ::-webkit-scrollbar-thumb { background: rgba(59, 130, 246, 0.25); border-radius: 9999px; }
        ::-webkit-scrollbar-thumb:hover { background: rgba(59, 130, 246, 0.45); }
        .dark ::-webkit-scrollbar-thumb { background: rgba(51, 65, 85, 0.6); }
...
<body class="bg-[#f6f9ff] dark:bg-[#030712] text-slate-800 dark:text-slate-100 relative min-h-screen antialiased transition-colors duration-300">

    {{-- Ambient Background Glows --}}
    <div class="fixed inset-0 pointer-events-none hologram-grid-blue z-0"></div>
    <div class="fixed top-[-20%] right-[-10%] w-[50rem] h-[50rem] bg-gradient-to-bl from-blue-400/10 dark:from-blue-600/15 to-transparent rounded-full blur-[120px] pointer-events-none z-0"></div>
    <div class="fixed bottom-[-10%] left-[-10%] w-[40rem] h-[40rem] bg-gradient-to-tr from-sky-400/10 dark:from-sky-500/10 to-transparent rounded-full blur-[100px] pointer-events-none z-0"></div>
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="glass-card rounded-3xl p-6 sm:p-8 relative overflow-hidden">
                        ...
                        {{-- Top Decorative Line --}}
                        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 via-sky-400 to-blue-600"></div>

                        <h2 class="text-2xl font-black text-slate-900 dark:text-white tracking-tight mb-8">
                            Kirim Penawaran
                        </h2>

                        <form action="{{ route('freelancer.penawaran.store', $project) }}"
                              method="POST"
                            ...
                            <div class="mb-8">
                                ...
                                <div class="relative w-full border-2 border-dashed border-blue-200 dark:border-slate-800 rounded-2xl bg-blue-50/30 dark:bg-slate-950/40 hover:bg-blue-50/70 dark:hover:bg-slate-900/60 hover:border-blue-400 dark:hover:border-slate-700 transition-all duration-300">
                                    <input type="file"
                                           name="proposal"
                                           accept=".pdf"
                ...
                <div>
                    <div class="glass-card rounded-3xl p-6 sticky top-24">
                        ...
                        <!-- Image Preview -->
                        <div class="rounded-2xl overflow-hidden border border-blue-100 dark:border-slate-800 mb-5 relative group shadow-sm">
                            <div class="absolute inset-0 bg-blue-600/10 dark:bg-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity z-10 pointer-events-none"></div>
                        ...
                        <div class="mt-6 space-y-4">
                            ...
                            <div>
                                ...
                                <h3 class="font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-500 dark:from-blue-400 dark:to-sky-300 text-2xl tracking-tighter">
                            ...
                            <div>
                                ...
                                <span class="inline-block bg-blue-50 dark:bg-blue-950/60 border border-blue-200 dark:border-blue-800/80 text-blue-600 dark:text-blue-300 px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest shadow-sm">
