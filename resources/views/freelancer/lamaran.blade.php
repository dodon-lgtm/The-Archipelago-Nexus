                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    @if($item->status === 'Menunggu')
                                        <form action="{{ route('freelancer.penawaran.destroy', $item) }}" method="POST"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                    class="inline-flex items-center gap-2 px-4 py-2 bg-red-50 dark:bg-red-900/40 hover:bg-red-100 dark:hover:bg-red-900/60 text-red-600 dark:text-red-300 text-xs font-semibold rounded-xl transition-colors duration-200 border border-red-200 dark:border-red-900">
