...
<div>
                        ...
                        <div>
                            ...
                            <input type="text" name="subject" value="{{ old('subject') }}"
                                class="w-full rounded-xl border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:border-red-400 focus:ring-2 focus:ring-red-100 outline-none @error('subject') border-red-300 @enderror"
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="5"
                                class="w-full rounded-xl border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:border-red-400 focus:ring-2 focus:ring-red-100 outline-none @error('description') border-red-300 @enderror"
...
{{-- Attachment / Bukti --}}
                        ...
                        <div class="flex items-center gap-3 pt-2">
                            ...
                            <a href="{{ url()->previous() }}" class="px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl text-sm font-semibold transition">
                                Batal
                            </a>
                        </div>
                    </form>
