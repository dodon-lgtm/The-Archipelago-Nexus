    ...
    <div class="flex-1 min-w-0 flex flex-col min-h-screen">
        ...
        <main class="flex-1 min-w-0 overflow-y-auto">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 py-8">
                ...
                {{-- MANUAL / DEMO PAYMENT BANNER --}}
                @if ((bool) config('services.midtrans.temporary_confirmation', false) && $payment->status !== 'paid')
                    <div class="mb-6 rounded-2xl border border-amber-200 bg-amber-50 p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                        <div>
                        ...
                        <button type="button" id="manualConfirmBtn"
                            class="shrink-0 px-4 py-2.5 bg-amber-500 hover:bg-amber-600 text-white rounded-xl text-xs font-bold transition disabled:opacity-60">
