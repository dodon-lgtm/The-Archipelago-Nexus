    ...
    <div class="p-8 pt-6">
        ...
        <div class="space-y-4">
            ...
            <div class="text-center">
                <!-- OTP Display - as large digits -->
                <div class="inline-block space-x-2">
                    {{-- We'll display each digit in a separate box --}}
                </div>
            </div>

            <p class="text-slate-500 text-sm">Kode OTP Anda:</p>

            <div class="flex justify-center space-x-2 my-4">
                <!-- Each OTP digit in its own input -->
                {{-- Digits will be populated by the frontend --}}
            </div>

            <p class="text-slate-500 text-sm">Kode ini berlaku selama 5 menit.</p>

            <p class="text-slate-500 text-sm">Jika Anda tidak meminta reset password, abaikan email ini.</p>

            <!-- Footer -->
            <div class="mt-8 pt-8 border-t border-blue-100/30 text-slate-500 text-xs">
                <p>ApexForge Labs</p>
