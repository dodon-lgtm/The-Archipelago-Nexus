...
@section('content')
    <div class="mb-4">
        <a href="{{ route('admin.company-account-requests.index') }}" class="text-sm text-blue-600 hover:text-blue-700 font-semibold inline-flex items-center gap-1">
                ...
                <div class="bg-white rounded-2xl border border-blue-100 shadow-sm p-5">
                    ...
                    <form method="POST" action="{{ route('admin.company-account-requests.approve', ['companyRequest' => $companyRequest->id]) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="w-full rounded-xl border-blue-100 bg-[#f6f9ff] px-4 py-2.5 text-sm focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none" id="note" name="note" rows="2">{{ old('note') }}</textarea>
                        </div>
                ...
                <div class="bg-white rounded-2xl border border-red-200 shadow-sm p-5">
                    ...
                    <form method="POST" action="{{ route('admin.company-account-requests.reject', ['companyRequest' => $companyRequest->id]) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="w-full rounded-xl border-blue-100 bg-[#f6f9ff] px-4 py-2.5 text-sm focus:border-blue-400 focus:ring-2 focus:ring-blue-100 outline-none" name="note" rows="2" required>{{ old('note') }}</textarea>
                        </div>
