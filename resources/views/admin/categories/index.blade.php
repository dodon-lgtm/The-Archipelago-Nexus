    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl border border-blue-100 shadow-sm p-5">
            <h2 class="font-bold text-slate-800 mb-4 flex items-center gap-2">
                <i class="fa-solid fa-plus-circle text-blue-500"></i> Tambah Kategori
            </h2>
            <form method="POST" action="{{ route('admin.categories.store') }}">
                ...
                <button type="submit" class="w-full px-4 py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-xl text-sm font-semibold transition">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="bg-white rounded-2xl border border-blue-100 p-4 mb-4 shadow-sm">
                <form method="GET" action="{{ route('admin.categories.index') }}" class="flex gap-3 items-end">
                    ...
                    <a href="{{ route('admin.categories.index') }}" class="px-4 py-2.5 bg-blue-50 hover:bg-slate-200 text-slate-600 rounded-xl text-sm font-semibold transition">
                        Reset
                    </a>
                </form>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="flex gap-3">
                    <button type="submit" class="flex-1 px-4 py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-xl text-sm font-semibold transition">
                        Simpan Perubahan
                    </button>
                    <button type="button" onclick="closeEditModal()" class="px-4 py-2.5 bg-blue-50 hover:bg-slate-200 text-slate-600 rounded-xl text-sm font-semibold transition">
                        Batal
                    </button>
                </div>
            </form>
