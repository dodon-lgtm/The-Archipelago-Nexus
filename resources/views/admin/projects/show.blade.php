...
@section('content')
    <div class="mb-4">
        <a href="{{ route('admin.projects.index') }}" class="text-sm text-blue-600 hover:text-blue-700 font-semibold inline-flex items-center gap-1">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-blue-100 shadow-sm p-5">
                ...
                @if($project->image)
                    <div class="mb-2"><p class="text-xs text-slate-500 font-semibold">Gambar</p><a href="{{ asset('storage/' . $project->image) }}" target="_blank" class="text-sm text-blue-600 hover:underline">Lihat</a></div>
                @endif
                @if($project->attachment)
                    <div><p class="text-xs text-slate-500 font-semibold">File</p><a href="{{ asset('storage/' . $project->attachment) }}" target="_blank" class="text-sm text-blue-600 hover:underline">Download</a></div>
                @endif
