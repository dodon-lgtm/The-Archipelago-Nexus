...
@section('content')
    ...
    <div class="fixed inset-0 z-0 pointer-events-none hologram-grid-bg overflow-hidden">
        ...
        <div class="absolute -top-32 -left-32 w-[40rem] h-[40rem] bg-gradient-to-br from-blue-600/20 to-cyan-400/20 rounded-full blur-[100px] animate-drift-slow mix-blend-multiply"></div>
        ...
        {{-- High-tech rings --}}
        <div class="absolute top-20 right-32 w-[40rem] h-[40rem] border-[0.5px] border-cyan-500/10 rounded-full animate-tech-ring hidden xl:block"></div>
    </div>
    ...
    <div class="relative z-10 px-4 sm:px-6 lg:px-8 py-8 max-w-[1600px] mx-auto space-y-12">
        ...
        <div class="glass-panel-dark relative overflow-hidden rounded-[2.5rem] p-8 sm:p-12 text-white">
            {{-- Inner Glows --}}
            <div class="absolute -right-20 -bottom-20 w-96 h-96 bg-cyan-500/30 rounded-full blur-[80px] pointer-events-none"></div>
            ...
            <div class="relative z-10 flex flex-col xl:flex-row xl:items-center justify-between gap-10">
                <div class="space-y-6 max-w-2xl">
                    <div class="inline-flex items-center gap-3 px-4 py-2 rounded-full text-xs font-bold bg-white/5 border border-white/10 backdrop-blur-md">
                        ...
                        <span class="text-cyan-300 tracking-wider uppercase">Hologram Command Center Live</span>
                    </div>
                    
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-cyan-200 drop-shadow-sm">
                ...
                <div class="flex items-center gap-5 bg-white/5 border border-white/10 p-5 rounded-[2rem] backdrop-blur-xl shadow-2xl self-start xl:self-auto relative overflow-hidden group">
                    <div class="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-cyan-400/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="w-14 h-14 rounded-2xl bg-gradient-to-tr from-cyan-500 to-blue-600 flex items-center justify-center text-white shadow-[0_0_20px_rgba(6,182,212,0.4)]">
                        <i class="fa-solid fa-shield-halved text-2xl"></i>
                    </div>
                    <div class="pr-4 relative z-10">
                        <p class="text-[11px] text-cyan-300 uppercase font-black tracking-widest mb-0.5">Status Sistem</p>
            ...
            @foreach($metrics as $metric)
                <div class="glass-panel-light relative overflow-hidden rounded-[2rem] p-6 group hover:-translate-y-2 hover:shader-glow-{{ $metric['color'] == 'cyan' ? 'cyan' : 'blue' }} transition-all duration-500 cursor-default">
                    ...
                    <div class="flex items-start justify-between relative z-10">
                        ...
                        <div class="w-12 h-12 rounded-[1.25rem] bg-slate-50 border border-slate-100 flex items-center justify-center text-{{ $metric['color'] }}-600 shadow-sm group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500">
                            <i class="fa-solid {{ $metric['icon'] }} text-xl"></i>
                        </div>
                    </div>
                    <div class="mt-5 pt-4 border-t border-slate-100/50 flex items-center text-xs font-semibold text-slate-500">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-7 glass-panel-light rounded-[2.5rem] flex flex-col overflow-hidden shader-glow-blue border border-blue-100/50">
                ...
                <div class="flex-1 overflow-y-auto custom-scroll max-h-[400px] px-8 pb-4">
                    <div class="space-y-3">
                        @forelse($recentRequests as $req)
                            <div class="group flex items-center justify-between p-4 rounded-2xl bg-white border border-slate-100 hover:border-blue-200 hover:shadow-[0_8px_30px_-12px_rgba(59,130,246,0.2)] transition-all duration-300">
                                <div>
                                ...
                                <a href="{{ route('admin.company-account-requests.show', $req) }}" class="flex items-center justify-center w-10 h-10 rounded-xl bg-slate-50 text-slate-400 group-hover:bg-blue-50 group-hover:text-blue-600 transition-colors">
                                    <i class="fa-solid fa-arrow-right -rotate-45"></i>
                                </a>
                            </div>
                        @empty
                            <div class="py-12 flex flex-col items-center justify-center text-slate-400">
                                <div class="w-16 h-16 rounded-3xl bg-slate-50 border border-slate-100 flex items-center justify-center mb-4">
                ...
                <div class="p-6 border-t border-slate-100 bg-white/50 text-center backdrop-blur-md">
            ...
            <div class="lg:col-span-5 glass-panel-light rounded-[2.5rem] flex flex-col overflow-hidden relative">
                <div class="px-8 py-6 flex items-center justify-between border-b border-slate-100">
                    <div class="flex items-center gap-3">
                        <div class="w-3 h-8 rounded-full bg-cyan-500 shadow-[0_0_15px_rgba(6,182,212,0.5)]"></div>
                        <div>
                    ...
                    <div class="space-y-4 relative before:absolute before:inset-y-0 before:left-[19px] before:w-px before:bg-slate-200">
                        @forelse($recentProjects as $project)
                            <div class="relative pl-12 group">
                                <div class="absolute left-0 top-1.5 w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center shadow-sm z-10 group-hover:border-cyan-400 group-hover:text-cyan-500 transition-colors">
                                    <div class="w-2.5 h-2.5 rounded-full bg-slate-300 group-hover:bg-cyan-500 group-hover:shadow-[0_0_10px_rgba(6,182,212,0.8)] transition-all"></div>
                                </div>
                                <div class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm group-hover:shadow-md transition-shadow">
                                    <div class="flex justify-between items-start gap-4">
                                        ...
                                        <span class="text-[10px] px-2.5 py-1 rounded-lg font-black uppercase tracking-wider
                                            @if($project->status == 'Open') bg-cyan-50 text-cyan-600 border border-cyan-100
                ...
                <div class="p-6 bg-slate-50 text-center">
                    <a href="{{ route('admin.projects.index') }}" class="text-xs font-black tracking-widest uppercase text-cyan-600 hover:text-cyan-800 transition-colors">
            ...
            <div class="lg:col-span-5 glass-panel-light rounded-[2.5rem] flex flex-col overflow-hidden relative">
                ...
                <div class="flex-1 p-6 space-y-3">
                    @forelse($recentPenawarans as $penawaran)
                        <div class="flex items-center justify-between p-4 rounded-2xl bg-white border border-slate-100 hover:border-indigo-200 hover:shadow-md transition-all group">
                ...
                <div class="p-6 bg-slate-50 text-center mt-auto">
            ...
            <div class="lg:col-span-7 glass-panel-light rounded-[2.5rem] flex flex-col overflow-hidden shader-glow-cyan border border-cyan-100/50">
                <div class="px-8 py-6 flex items-center justify-between relative">
                    <div class="absolute inset-0 bg-gradient-to-r from-cyan-50/50 to-transparent pointer-events-none"></div>
                    <div class="flex items-center gap-4 relative z-10">
                        <div class="w-12 h-12 rounded-2xl bg-cyan-500 text-white flex items-center justify-center shadow-[0_0_20px_rgba(6,182,212,0.4)]">
                ...
                <div class="flex-1 p-8 grid gap-4 grid-cols-1 md:grid-cols-2">
                    @forelse($recentReports as $report)
                        <div class="p-5 rounded-2xl bg-white border border-slate-100 hover:border-cyan-300 hover:shadow-[0_10px_30px_-10px_rgba(6,182,212,0.2)] transition-all flex flex-col justify-between h-full">
                            <div>
                            ...
                            <div class="pt-3 mt-3 border-t border-slate-100/80 flex items-center gap-2">
                                <div class="w-6 h-6 rounded-full bg-slate-100 flex items-center justify-center text-[10px] text-slate-500"><i class="fa-solid fa-user"></i></div>
                ...
                <div class="p-6 border-t border-slate-100 bg-white/50 text-center backdrop-blur-md mt-auto">
                    <a href="{{ route('admin.reports.index') }}" class="text-xs font-black tracking-widest uppercase text-cyan-600 hover:text-cyan-800 transition-colors">
