...
<body
    class="bg-[#f6f9ff] text-slate-800 antialiased selection:bg-blue-600 selection:text-white">

    <!-- Background Glow -->
    <div class="apex-page-glow"></div>
    ...
    <header
        class="bg-white/80 backdrop-blur-md border-b border-blue-100/80 sticky top-0 z-50">
        ...
        <div
            ...
            <a href="{{ route('landing') }}"
                ...
                <div
                    class="w-9 h-9 sm:w-10 sm:h-10 rounded-xl overflow-hidden
                ...
                <span
                    class="font-extrabold text-base sm:text-xl
            ...
            <button
                id="mobile-menu-btn"
                class="lg:hidden p-2 rounded-xl text-slate-600
                hover:bg-blue-50 transition focus:outline-hidden"
            ...
            <nav class="hidden lg:flex items-center gap-1">
                ...
                <a href="#home"
                    ...
                    hover:bg-blue-50/80 rounded-xl transition">
            ...
            <div class="hidden lg:flex items-center gap-3">
                ...
                @else
                    ...
                    <a href="{{ route('login') }}"
                        ...
                        border border-blue-100/80
                        rounded-xl hover:bg-blue-50/60 transition">
        ...
        <div
            id="mobile-menu"
            class="hidden lg:hidden bg-white
            border-b border-blue-100
            px-4 py-4 space-y-3">

            <a href="#home"
                class="block px-3 py-2 text-sm font-semibold
                text-slate-700 hover:bg-[#f6f9ff] rounded-lg">
            ...
            <div class="pt-3 border-t border-blue-50">
                ...
                @auth
                    ...
                    @if (Auth::user()->role === 'freelancer')
                        ...
                        <a href="{{ route('freelancer.dashboard') }}"
                            class="block px-4 py-2.5 text-sm font-bold
    ...
    <section
        ...
        bg-gradient-to-b from-blue-50/70
        via-slate-50 to-slate-50
        ...
        <div
            ...
            <div
                ...
                <div class="lg:col-span-7 space-y-6 sm:space-y-8">
                    ...
                    <h1
                        class="text-3xl sm:text-5xl lg:text-6xl
                    ...
                    <p
                        ...
                        ApexForge Labs mempertemukan
                        <strong>freelancer berbakat</strong>
                        dengan
                        <strong>perusahaan terpercaya</strong>
                        untuk menggarap proyek digital secara
                    ...
                    <div
                        ...
                        <p
                            ...
                            <strong
                                class="text-slate-900 font-extrabold">
    ...
    <section
        ...
        <div class="text-center mb-10 sm:mb-14">
            ...
            <p
                ...
                Temukan pekerjaan atau talenta
                spesifik sesuai kebutuhan industri Anda
        ...
        <div
            ...
            <div class="text-center mb-10 sm:mb-14">
                ...
                <p
                    ...
                    memenangkan proyek freelance berkualitas
            ...
            @if ($recentProjects->count() > 0)
                ...
                <div
                    ...
                    @foreach ($recentProjects as $project)
                        ...
                        <!--
                            CARD PROJECT
                            SEKARANG SELURUH CARD ADALAH LINK
                            KE DETAIL PROJECT
                        -->

                        <a
                            href="{{ url('/freelancer/projects/' . $project->id) }}"
                            class="group
                            bg-[#f6f9ff]/50
                            hover:bg-white
                            border border-blue-100/80
   ...
   class="group block">
            ...
            @else
                ...
                <div class="text-center py-12">
                    ...
                    <p
                        ...
                        Belum ada proyek terbaru saat ini.
    ...
    <!-- ============================================================ -->
<!-- 6. UNTUK FREELANCER (Hanya tampil jika belum login / role freelancer) -->
<!-- ============================================================ -->
@auth
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-6 order-1 lg:order-2">
                    ...
                    <p
                        ...
                        Bergabunglah bersama ribuan talenta
                        digital Indonesia dan mulailah
                    ...
                    <div
                        class="grid sm:grid-cols-2 gap-4 pt-2">
                    ...
                    <div class="space-y-3 pt-2">
                        ...
                        <div class="flex items-center gap-3.5 p-3.5 rounded-2xl bg-[#f6f9ff] border border-blue-100/80 shadow-xs">
                            ...
                            <p
                                ...
                                Akses ratusan proyek
                                sesuai spesialisasi utama Anda.
                        ...
                        <div
                            ...
                            <p
                                ...
                                Pembayaran terjamin melalui
                                alur proyek yang transparan.
                        ...
                        <div
                            ...
                            <p
                                ...
                                Dapatkan ulasan positif
                                untuk meningkatkan tarif Anda.
                    ...
                    <div class="pt-2">
                        <a
                            href="{{ route('freelancer.projects.index') }}"
                            class="inline-flex items-center gap-2
                            px-7 py-3.5
                            bg-emerald-600
                    ...
                    <div
                        ...
                        <div
                            ...
                            <p
                                ...
                                memudahkan saya mendapat klien tetap!"
    ...
    @endif
@else
    <!-- Jika belum login, tampilkan section Freelancer standar -->
    <section
        id="freelancer"
        class="scroll-offset
        max-w-7xl mx-auto
...
<!-- ============================================================ -->
<!-- 7. UNTUK PERUSAHAAN (Hanya tampil jika belum login / role company) -->
<!-- ============================================================ -->
@auth
                ...
                <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p
                                    ...
                                    "Kualitas talenta di platform ini
                                    sangat memuaskan dan tepat waktu."
                    ...
                    <div
                        ...
                        <p
                            ...
                            Selesaikan pekerjaan digital
                            bisnis Anda lebih cepat dengan
                            dukungan tim profesional independen
                            yang terverifikasi.
    ...
    @endif
@else
    <!-- Jika belum login, tampilkan section Company standar -->
    <section
        id="company"
        class="scroll-offset
        bg-white py-16 sm:py-24
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white border border-blue-100/80 rounded-2xl p-6 text-center shadow-xs hover:shadow-xl transition duration-300">
                ...
                <p
                    ...
                    Buat profil Anda sebagai
                    Freelancer atau Perusahaan secara gratis.
            ...
            <div class="bg-white border border-blue-100/80 rounded-2xl p-6 text-center shadow-xs hover:shadow-xl transition duration-300">
                ...
                <p
                    ...
                    Cari proyek menarik
                    atau buka lowongan proyek baru.
            ...
            <div class="bg-white border border-blue-100/80 rounded-2xl p-6 text-center shadow-xs hover:shadow-xl transition duration-300">
                ...
                <p
                    ...
                    dan berikan penilaian hasil kerja.
    ...
    <section class="relative overflow-hidden py-16 sm:py-20 my-8 mx-4 sm:mx-8 lg:mx-auto max-w-7xl rounded-3xl bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 text-white shadow-2xl shadow-blue-500/20">
        <div class="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
            ...
            <p
                ...
                Lanjutkan perjalanan Anda dan temukan
                peluang baru hari ini.
        ...
        @else
            ...
            <p
                ...
                Bergabunglah bersama ribuan talenta
                digital dan perusahaan di platform
                ApexForge Labs sekarang juga.
            ...
            <div
                ...
                <div class="space-y-4">
                    ...
                    <p
                        ...
                        Platform marketplace freelance
                        terpercaya yang menghubungkan
                        talenta berbakat dengan perusahaan
                        untuk mewujudkan proyek digital
                        secara profesional.
