...
<aside id="sidebar" class="w-64 bg-white/95 backdrop-blur-3xl border-r border-blue-100 flex flex-col h-screen sticky top-0 shrink-0 z-30 shadow-[10px_0_40px_-10px_rgba(59,130,246,0.08)]">
    ...
    {{-- LOGO SECTION --}}
    <div class="sidebar-logo-wrapper p-6 flex items-center gap-3 border-b border-blue-50 shrink-0 transition-all duration-300 relative">
        
        {{-- Mobile hamburger --}}
        <button id="mobileSidebarToggle" class="sidebar-hamburger-mobile w-10 h-10 rounded-xl hover:bg-blue-50 flex items-center justify-center shrink-0 transition-colors mr-1 shadow-[0_4px_10px_rgba(59,130,246,0.05)] text-blue-600">
        ...
        <div class="sidebar-logo-text transition-all duration-300 overflow-hidden">
            <h2 class="font-black text-[13px] leading-tight text-blue-950 whitespace-nowrap tracking-tight">
                ApexForge<br>
                <span class="text-blue-600">Labs</span>
            </h2>
        </div>
        
        {{-- Desktop toggle button --}}
        <button id="sidebarToggle" class="sidebar-toggle-desktop w-8 h-8 rounded-xl hover:bg-blue-50 flex items-center justify-center shrink-0 ml-auto transition-all duration-300 group shadow-sm border border-transparent hover:border-blue-100">
            <i class="sidebar-toggle-icon fa-solid fa-chevron-left text-blue-400 text-xs transition-transform duration-300 group-hover:-translate-x-0.5"></i>
        </button>

        {{-- Collapsed toggle button --}}
        <button id="sidebarToggleCollapsed" class="sidebar-toggle-collapsed w-8 h-8 rounded-xl hover:bg-blue-50 flex items-center justify-center shrink-0 mx-auto transition-all duration-300 group shadow-sm border border-transparent hover:border-blue-100">
            <i class="sidebar-toggle-icon fa-solid fa-chevron-right text-blue-400 text-xs transition-transform duration-300 group-hover:translate-x-0.5"></i>
        </button>
    </div>
            ...
            @if(Auth::user()->role == 'freelancer')
                ...
                <a href="{{ route('freelancer.dashboard') }}"
                   ...
                   {{ request()->routeIs('freelancer.dashboard')
                       ...
                       : 'text-blue-900/60 hover:bg-blue-50/80 hover:text-blue-700 font-semibold' }}"
...
<div class="pt-4 pb-1">
                    <div class="h-px w-full bg-gradient-to-r from-transparent via-blue-100 to-transparent"></div>
                </div>

                <div>
                    <button type="button" data-bantuan-toggle
                        class="relative w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl transition-all duration-300 group text-blue-900/60 hover:bg-blue-50/80 hover:text-blue-700 font-semibold"
                        data-tooltip="Bantuan">
                        <i class="fa-solid fa-circle-question w-5 text-center transition-transform group-hover:scale-110"></i>
                    ...
                    <div class="bantuan-submenu hidden pl-12 space-y-1 mt-1">
                        <a href="{{ route('reports.create') }}"
                           ...
                           {{ request()->routeIs('reports.create')
                               ? 'bg-gradient-to-r from-blue-600 to-blue-500 text-white shadow-[0_8px_20px_-6px_rgba(59,130,246,0.6)] font-bold'
                               : 'text-blue-900/60 hover:bg-red-50/80 hover:text-red-600 font-semibold' }}"
...
<div class="pt-4 pb-1">
    ...
    {{-- SIDEBAR FOOTER --}}
    <div class="p-5 shrink-0 sidebar-footer-wrapper border-t border-blue-50 bg-white/50 relative z-10">
        ...
        <div class="sidebar-footer-mini hidden">
            <div class="w-10 h-10 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-500 flex items-center justify-center mx-auto shadow-[0_5px_15px_rgba(59,130,246,0.4)]">
...
<style>
    ...
    .custom-sidebar-scroll:hover::-webkit-scrollbar-thumb { background: rgba(59, 130, 246, 0.4); }
